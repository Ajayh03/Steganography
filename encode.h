...
typedef struct _EncodeInfo
{
    ...
    FILE *fptr_src_image;       //file pointer to source image file
    uint image_capacity;        //variable to store image capacity
    ...
    FILE *fptr_stego_image;     //file pointer to stego image file
...
Status encode_int_to_lsb(int value, char *image_buffer);
